...
export const NAV_BY_ROLE: Record<UserRole, RoleNavItem[]> = {
  student: [
    ...
    { key: "auloes",  label: "Aulões",  Icon: Radio,       href: "/student/auloes"  },
  ...
  teacher: [
    ...
    { key: "auloes",   label: "Aulões",  Icon: Radio,       href: "/teacher/auloes"  },
  ...
  manager: [
    ...
    { key: "analise-alunos", label: "Análise de Alunos",  Icon: ChartBar,             href: "/manager/analise-alunos"  },
    { key: "risco",          label: "Alunos em Risco",    Icon: Warning,              href: "/manager/risco"           },
    { key: "professores",    label: "Professores",        Icon: UsersThree,           href: "/manager/professores"     },
